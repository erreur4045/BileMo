...
class GetPhonesResolver
{
    ...
    public function resolve(Request $request)
    {
        ...
        if ($nbMaxPage > 1 and  $page == null)
            $page = 1;
        if ($page > $nbMaxPage)
            throw new BadRequestHttpException(sprintf('The requested page does not exist, last page is api/phones?page=%s', $nbMaxPage),null,Response::HTTP_BAD_REQUEST,['Content-type' => 'application/json']);
